    ...
    public static class PlanSeeder
    {
        public static async Task SeedAsync(ApplicationDbContext context, ILoggerFactory loggerFactory)
        {
            ...
            var targetPlans = new List<Plan>
            {
                ...
                CreatePlan($"{PlanTiers.Standard}_6M", "Tiêu Chuẩn (6 Tháng)", 339000, 210, LimitedFeature(30, 100, 3, false)),
                CreatePlan($"{PlanTiers.Standard}_12M", "Tiêu Chuẩn (1 Năm)", 639000, 420, LimitedFeature(30, 100, 3, false)),

                // =====================
                // PREMIUM (99k)
                // =====================
                CreatePlan($"{PlanTiers.Premium}_1M", "Cao Cấp (1 Tháng)", 99000, 30, LimitedFeature(100, 500, 10, true)),
                CreatePlan($"{PlanTiers.Premium}_3M", "Cao Cấp (3 Tháng)", 279000, 90, LimitedFeature(100, 500, 10, true)),
                CreatePlan($"{PlanTiers.Premium}_6M", "Cao Cấp (6 Tháng)", 539000, 240, LimitedFeature(100, 500, 10, true)),
                CreatePlan($"{PlanTiers.Premium}_12M", "Cao Cấp (1 Năm)", 1009000, 480, LimitedFeature(100, 500, 10, true)),

                // =====================
                // BUSINESS (139k)
                // =====================
                CreatePlan($"{PlanTiers.Business}_1M", "Doanh Nghiệp (1 Tháng)", 139000, 30, UnlimitedFeature()),
                CreatePlan($"{PlanTiers.Business}_3M", "Doanh Nghiệp (3 Tháng)", 369000, 120, UnlimitedFeature()),
                CreatePlan($"{PlanTiers.Business}_6M", "Doanh Nghiệp (6 Tháng)", 709000, 240, UnlimitedFeature()),
                CreatePlan($"{PlanTiers.Business}_12M", "Doanh Nghiệp (1 Năm)", 1329000, 480, UnlimitedFeature())
            };
